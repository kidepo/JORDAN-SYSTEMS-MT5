...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title                  ="Check_1";   // Document name
ulong                    Expert_MagicNumber            =27155;       //
...
input int                Signal_1_MA_PeriodMA          =34;          // Moving Average(34,0,...) Period of averaging
input int                Signal_1_MA_Shift             =0;           // Moving Average(34,0,...) Time shift
input ENUM_MA_METHOD     Signal_1_MA_Method            =MODE_SMA;    // Moving Average(34,0,...) Method of averaging
input ENUM_APPLIED_PRICE Signal_1_MA_Applied           =PRICE_CLOSE; // Moving Average(34,0,...) Prices series
input double             Signal_1_MA_Weight            =1.0;         // Moving Average(34,0,...) Weight [0...1.0]
//--- inputs for trailing
