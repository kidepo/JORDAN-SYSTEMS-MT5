...
#property description "Based on Silver Trend Indicator"
...
int TRD1000Handle;
int MagicNumber=0;
string EA_Version = "#Jordan-5-v1.01";
...
{  
   ...
   ArraySetAsSeries(sellTail,true);
	...
	if(TradeOnNewBar == true) 
	{
		...
		if(newBar){
	   TRD1000Handle = iCustom(_Symbol,_Period, "TREND_1000");  
	...
	//else TRD1000Handle = iCustom(_Symbol,_Period, "TREND_1000");
	if(alertsOnCurrent)
	   TRD1000Handle = iCustom(_Symbol,_Period, "TREND_1000");
